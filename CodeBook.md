## A code book that describes the variables, the data, and  work performed to clean up the data
###Data Set Information:

This information is taken from here. ###Remain 
...
### A full description of data and variables is available at the site from where the data was obtained: 
...
5.Then to clean the variables and give it descriptive names:
